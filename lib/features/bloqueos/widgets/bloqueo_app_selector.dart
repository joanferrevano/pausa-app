...
class BloqueoAppSelector extends StatefulWidget {
  ...
  @override
  State<BloqueoAppSelector> createState() => _BloqueoAppSelectorState();
}

class _BloqueoAppSelectorState extends State<BloqueoAppSelector> {
  @override
  void initState() {
    super.initState();
